...
# @manual
# @description
# Klassisches Pong gegen die KI.
# Erster mit 5 Punkten gewinnt.
#
# @controls
# Pfeil hoch / runter : Schlaeger bewegen
...
def update():
    ...
    # KI: simple Verfolgung mit kleinem Delay
    ...
    if (ball_x < 6 and ball_dx < 0
        ...
        ball_dx = -ball_dx * 1.05    # leicht beschleunigen
        # Ablenkung je nach Trefferpunkt
...
def draw():
    ...
    if score_player >= 5 or score_ai >= 5:
        msg = "DU GEWINNST!" if score_player > score_ai else "KI GEWINNT!"
